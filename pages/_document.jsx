...
export default function Document() {
  return (
    ...
    >
      <Head>
        <meta name="title" content="benjamin lee" />
        ...
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dhtviyhse/image/upload/v1682600618"
        />

        {/* <!-- Twitter --> */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://" />
        <meta property="twitter:title" content="benjamin lee" />
        <meta
        ...
        {/* whatsapp */}
        <meta property="og:site_name" content="benjamin lee" />
        <meta property="og:title" content="benjamin lee" />
        <meta
          property="og:description"
          content="Developer // Designer // Weeb"
