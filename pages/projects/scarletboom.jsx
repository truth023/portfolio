      ...
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" mx-auto flex flex-col ">
            ...
            >
              I designed a prominent feature that provides users with a
              comprehensive list of trending AWS, including corresponding prices
              and data on profit or loss. This noteworthy addition not only
              offers valuable insights into current market trends but also
              empowers users to stay well-informed about the performance metrics
              of different AWS services. Now, users can easily track and analyze
              the financial aspects of AWS, enhancing their decision-making in
