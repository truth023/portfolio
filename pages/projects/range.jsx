      ...
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" mx-auto flex flex-col ">
            ...
            >
              As a React frontend developer, I mainly focusing on porting the
              site to a new build on a headless CMS system, using Gatsby and
              Sanity as well as developing components.
            </h4>
            <h4
              className={`mt-10 only:mb-12 font-deca bg-gradient-to-br bg-clip-text selection:text-gray-700 dark:selection:text-white/90 items-center mx-auto text-sm md:text-lg lg:text-lg xl:text-lg `}
            >
              Establish purpose and responsibility in meetings by utilizing
              multiplayer agendas, notes, and tools that foster an inclusive
              environment for everyone. These collaborative features not only
              enhance the meeting experience but also promote engagement,
              ensuring that all participants have a meaningful role in the
