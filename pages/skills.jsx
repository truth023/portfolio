  ...
  const data = [
    {
      ...
      desc: "The best coding Integrated Development Environment (IDE) ever created, offering a plethora of customization options.",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "A programming language with first-class functions, designed to be lightweight, interpreted, or just-in-time compiled.",
      tag: "code",
      bg: "bg-yellow-50",
    ...
    },
    {
      ...
      desc: "Microsoft's creation, a powerful extension of JavaScript with robust type safety.",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "A front-end JavaScript library for building user interfaces based on components, freely available and open-source.",
      tag: "develop",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "A web development framework that is open-source and facilitates the creation of React-based web applications.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      ...
      desc: "A CSS framework focused on utility-first principles, enabling the rapid construction of modern websites directly within your HTML.",
      tag: "design",
      bg: "bg-green-50",
      text: "text-green-500",
    },
    {
      ...
      desc: "A complete set of UI tools designed to accelerate the delivery of new features.",
      tag: "develop",
      bg: "bg-indigo-50",
    ...
    },
    {
      ...
      desc: "CSS with enhanced capabilities. The most potent, professional-grade CSS extension language globally.",
      tag: "design",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
    {
      ...
      desc: "A fresh tool that consolidates your daily work applications into a single platform. It serves as the all-in-one workspace for both you and your team.",
      tag: "productivity",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      ...
      desc: "A valuable resource for web app designers, it encompasses everything from wireframing to animation.",
      tag: "design",
      bg: "bg-orange-500",
    ...
    },
    {
      ...
      desc: "The preferred platform for developers to collaborate and showcase their code.",
      tag: "platform",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      ...
      id: 11,
      main: "/brave-icon.svg",
      desc: "A privacy-focused browser used to block ads and additional pop-ups.",
      tag: "platform",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
      ...
      <main className="max-w-screen max-w-5xl mx-auto">
        <div className="pt-24 flex flex-col mx-auto">
          ...
          <p className="mt-8 font-normal lg:text-lg text-center md:w-[70%] mx-auto text-base md:text-[1.15rem] ">
            Like any other developer, I also spend more time searching for and
            experimenting with tools than actually coding meaningful things.
          </p>
        </div>
